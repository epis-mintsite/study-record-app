...
import { BookOpen, PenLine, Users, LogOut, BarChart2, NotebookPen, Trophy, GraduationCap, LayoutGrid } from 'lucide-react';
...
const studentNavItems = [
  ...
  { href: '/learning-apps', label: '学習アプリ',  icon: LayoutGrid },
